            ...
            <section className="relative md:pb-24 pb-16">
                ...
                <div className="container lg:mt-24 mt-16">
                    <div className="grid grid-cols-1 pb-8 text-center">
                        ...
                        <p className="text-slate-400 max-w-xl mx-auto">Our advanced brokerage calculator is a powerful tool designed to empower traders like you. It provides a clear and transparent breakdown of the costs associated with your trades, helping you make informed decisions and maximize your profits.</p>
                    </div>
                        ...
                        <div className="lg:w-3/5 md:w-4/5">
                            <div className="p-6 shadow dark:shadow-gray-700 rounded-md" role="form">
                                <ul className="list-none flex justify-between">
                                    <li className="h6">Min € 50000</li>
                                    <li className="h6">Max € 1000000</li>
                                </ul>

                                <div className="row">
                                    <div className="col-sm-12 mb-4">
                                        <label htmlFor="slider" className="form-label"></label>
                                        <input id="slider" onInput={handleChange} type="range" defaultValue="200000" min="50000" max="1000000" className="w-full h-2 bg-gray-100 rounded-lg appearance-none cursor-pointer dark:bg-gray-700" />
                                    </div>
                                </div>
